...
export const SebiLogo = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 120 40" width="95" height="28" fill="currentColor" {...props}>
    <text x="5" y="28" fontFamily="'Plus Jakarta Sans', sans-serif" fontWeight="900" fontSize="28" letterSpacing="0.5">SEBI</text>
...
export const RbiLogo = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 120 40" width="105" height="28" fill="currentColor" {...props}>
    ...
    <text x="44" y="32" fontFamily="'Plus Jakarta Sans', sans-serif" fontWeight="600" fontSize="7.5" letterSpacing="0.15" opacity="0.8">RESERVE BANK</text>
  </svg>
);
...
export const NseLogo = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 120 40" width="95" height="28" fill="currentColor" {...props}>
    ...
    <text x="44" y="27" fontFamily="'Plus Jakarta Sans', sans-serif" fontWeight="800" fontSize="20" letterSpacing="0.5">NSE</text>
  </svg>
);
...
export const BseLogo = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 120 40" width="95" height="28" fill="currentColor" {...props}>
    ...
    <text x="44" y="27" fontFamily="'Plus Jakarta Sans', sans-serif" fontWeight="800" fontSize="20" letterSpacing="0.5">BSE</text>
  </svg>
);
...
export const NsdlLogo = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 120 40" width="105" height="28" fill="currentColor" {...props}>
    ...
    <text x="36" y="27" fontFamily="'Plus Jakarta Sans', sans-serif" fontWeight="800" fontSize="18" letterSpacing="0.5">NSDL</text>
  </svg>
);
...
export const CdslLogo = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 120 40" width="105" height="28" fill="currentColor" {...props}>
    ...
    <text x="36" y="27" fontFamily="'Plus Jakarta Sans', sans-serif" fontWeight="800" fontSize="18" letterSpacing="0.5">CDSL</text>
  </svg>
);
...
export const AmfiLogo = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 120 40" width="105" height="28" fill="currentColor" {...props}>
    ...
    <text x="36" y="27" fontFamily="'Plus Jakarta Sans', sans-serif" fontWeight="800" fontSize="18" letterSpacing="0.5">AMFI</text>
  </svg>
);
...
export const NpciLogo = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 120 40" width="105" height="28" fill="currentColor" {...props}>
    ...
    <text x="36" y="27" fontFamily="'Plus Jakarta Sans', sans-serif" fontWeight="800" fontSize="18" letterSpacing="0.5">NPCI</text>
  </svg>
);

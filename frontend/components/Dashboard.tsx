              ...
              <div className="ud-tab-content">
                    ...
                    >
                      <defs>
                        <linearGradient id="udGrad" x1="0" y1="0" x2="0" y2="1">
                          <stop offset="0%" stopColor="#13735d" stopOpacity=".25" />
                          <stop offset="100%" stopColor="#13735d" stopOpacity="0" />
                        </linearGradient>
                      </defs>
                  ...
                  <div className="ud-card">
                    ...
                    <div className="ud-quick-actions">
                      <Link href="/markets" className="ud-action-btn">
                        <div className="ud-action-icon" style={{ background: "linear-gradient(135deg, #13735d, #0ea5e9)" }}>
                ...
                <div className="ud-grid-3">
                  <div className="ud-card ud-insight-card">
                    <div className="ud-insight-icon" style={{ background: "linear-gradient(135deg, #13735d, #0ea5e9)" }}>

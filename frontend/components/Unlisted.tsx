    ...
    <>
      <section id="unlisted" className="unlisted-v2">
        ...
        <style jsx global>{`
          ...
          /* Phone class per the breakpoint contract in _tokens.css. */
          @media (max-width: 599px) {
            ...
            /* The input deliberately keeps its 1rem size: this selector is
               id-scoped, so anything smaller here would beat the 16px floor in
               _tokens.css and bring back the iOS focus zoom. */
          }
        `}</style>
        <div className="container">
          <div className="unlisted-hero-layout" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '32px', marginBottom: '48px', flexWrap: 'wrap' }}>
            ...
            <div className="sec-head reveal" style={{ flex: '2 1 300px', textAlign: 'center', margin: 0 }}>
              ...
              <a className="ul-wa-cta" href={cms.t("whatsapp", "link", "https://chat.whatsapp.com/your-invite-link")} target="_blank" rel="noopener noreferrer" style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', flexWrap: 'wrap', gap: '8px', background: '#25D366', color: '#fff', padding: '10px 24px', borderRadius: '30px', fontWeight: 600, textDecoration: 'none', boxShadow: '0 4px 14px rgba(37, 211, 102, 0.3)', transition: 'transform 0.2s', maxWidth: '100%', textAlign: 'center' }}>

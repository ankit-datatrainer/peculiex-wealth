...
const ACTIVITIES: Activity[] = [
  ...
  { name: "Vikram I.", city: "Delhi", action: "Lump sum in Mutual Fund", detail: "₹2,00,000", time: "6 min", color: "#01696f" },
  ...
  { name: "Suresh G.", city: "Ahmedabad", action: "SIP · ICICI Bluechip", detail: "₹20,000/mo", time: "21 min", color: "#01696f" },

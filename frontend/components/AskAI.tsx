...
const LINKS = [
  {
    name: "ChatGPT",
    href: `https://chatgpt.com/?prompt=${ENC}`,
    logo: (
  ...
  },
  {
    ...
    logo: (
      <svg viewBox="0 0 24 24" aria-hidden="true" fill="#D97757">
        <path d="M17.3041 3.541h-3.6718l6.696 16.918H24Zm-10.6082 0L0 20.459h3.7442l1.3693-3.5527h7.0052l1.3693 3.5528h3.7442L10.5363 3.541Zm-.3712 10.2456 2.2914-5.9456 2.2914 5.9456Z" />
      </svg>
    )
  },
  {
    ...
    logo: (
      <svg viewBox="0 0 24 24" aria-hidden="true">
        ...
        <path
          fill="url(#geminiGrad)"
          d="M12 0c.3 6.4 5.6 11.7 12 12-6.4.3-11.7 5.6-12 12-.3-6.4-5.6-11.7-12-12C6.4 11.7 11.7 6.4 12 0Z"
        />
      </svg>
    )
  }
...
export default function AskAI() {
  return (
    <div className="ask-ai reveal">
      <div className="ask-ai-logos">
        {LINKS.map((l) => (
          <a
            key={l.name}
            href={l.href}

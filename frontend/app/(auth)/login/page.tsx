              ...
              <form onSubmit={onSubmit}>
                ...
                <label>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 6 }}>
                    <span>Password</span>
                    <Link href="/forgot-password" tabIndex={-1} style={{ fontSize: "0.85rem", color: "var(--color-primary, #01696f)", textDecoration: "none", fontWeight: 500 }}>
                      Forgot Password?
                    </Link>
                  </div>
